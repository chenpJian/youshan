<template>
    <div class="AddKnow">
        <Sider :style="{position: 'fixed', height: '100vh', left: 0, overflow: 'auto'}">
            <Menu active-name="addknow" @on-select="routeTo" theme="dark" width="auto" :open-names="['1']">
                <Submenu name="1">
                    <template slot="title">
        ...
        <Layout :style="{marginLeft: '200px'}">
            ...
            <Content :style="{padding: '0 16px 16px'}">
                <Card>
                    <div id="operate2">
                        <div class="operate3">小知识标题:<br><Input v-model="knowTitle" style="width: 600px" /></div>
                        <div class="operate3">小知识内容:<br><Input v-model="knowAlt" type="textarea" :autosize="{minRows: 10}" style="width: 600px;" /></div>
                        <Button id="add2" type="success" @click="addKnowInfo()">添加</Button>
                    </div>
                </Card>
            </Content>
        </Layout>
